...
const howToSteps = [
  { name: 'Enter the role', text: 'Provide the role and a short note about the team or product.' },
  { name: 'Build the ramp', text: 'Generate the 30/60/90 plan with check-ins and a first-week checklist.' },
  { name: 'Assign and share', text: 'Confirm owners, edit milestones, and share with the new hire and manager.' },
]
...
export default function Page() {
  ...
  const SHORT = "OnboardPlan builds a 30/60/90 day onboarding plan by role."
  return (
    <>
      <Head>
      ...
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-lg font-semibold text-slate-900" data-geo-short-lead="1">OnboardPlan builds a 30/60/90 day onboarding plan by role.</p>
