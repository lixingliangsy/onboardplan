  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://onboardplan.lxsaihub.com/" />
      
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is OnboardPlan?", "acceptedAnswer": {"@type": "Answer", "text": "OnboardPlan builds a 30/60/90 day onboarding plan by role with check-ins and a first-week checklist."}}, {"@type": "Question", "name": "What inputs does it need?", "acceptedAnswer": {"@type": "Answer", "text": "The role and a little context about the team or product."}}, {"@type": "Question", "name": "Does it include owners?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Check-ins list suggested owners so accountability is clear."}}, {"@type": "Question", "name": "Who should use it?", "acceptedAnswer": {"@type": "Answer", "text": "Managers and People Ops who need a structured ramp without a full L&D team."}}, {"@type": "Question", "name": "Can I edit the plan?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Treat it as a draft you tailor to your company."}}, {"@type": "Question", "name": "Does it replace HR policy?", "acceptedAnswer": {"@type": "Answer", "text": "No. It is decision-support for onboarding plans, not legal or HR policy."}}]}` }} />
        </Head>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="definition" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">OnboardPlan - definition</h2>
...
<section id="features" className="py-20">
        ...
        <section id="studio" className="py-20">
          ...
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-extrabold text-center mb-4">Trusted by compliance-minded PMs</h2>
            <p className="text-center text-slate-600 mb-12 max-w-2xl mx-auto">
              Social proof uses templates until real, consented testimonials exist. Trusted by <strong>[X]+</strong> product and legal leads shipping AI into the EU.
            </p>
