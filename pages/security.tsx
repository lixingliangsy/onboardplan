  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={NAME + " — How OnboardPlan handles your data and the compliance posture it maintains."} />
      </Head>
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-slate-600">Get a structured onboarding plan by role - what the new hire should learn, do, and own by day 30, 60, and 90.</p>
          <h2 className="mt-8 text-xl font-semibold text-slate-900">What we handle</h2>
          <p className="mt-2 text-slate-600">OnboardPlan processes the text or configuration you submit to produce its output. We do not train public models on your submissions without explicit consent.</p>
