 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="onboardplan" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "onboardplan";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "onboardplan") + "_chat_session";
