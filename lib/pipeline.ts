...
export const PIPELINE_ID = 'onboardplan-v1'
export const STEP_ORDER: StepId[] = ['input', 'process', 'output']
export const STEP_LABELS: Record<StepId, string> = {
  input: "Step 1/3 · Role & team context",
  process: "Step 2/3 · Build 30/60/90 milestones",
  output: "Step 3/3 · Check-ins + first-week checklist",
}
