...
>
> Get a structured onboarding plan by role - what the new hire should learn, do, and own by day 30, 60, and 90.
...
```bash
npm run build
# Vercel: import repo, set framework = Next.js, root = 12_Micro_SaaS/onboardplan
```
